...
case $response in
    [yY][eE][sS]|[yY]) 
        echo "Starting..."
curl -o /root/pw.sh https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/pw.sh
sh pw.sh
rm -rf pw.sh
        ;;
    *)
...
curl -o /etc/chrony/chrony.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/chrony.conf
...
https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/mysqld_openstack.cnf
service mysql restart
apt-get -y install expect
curl -o /root/dbsec.sh https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/dbsec.sh
sh dbsec.sh
rm -rf dbsec.sh
        ;;
    *)
...
curl -o /root/mongodb.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/mongodb.conf
...
curl -o /etc/keystone/keystone.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/keystone.conf
...
case $response in
    [yY][eE][sS]|[yY]) 
        echo "Starting..."
curl -o /etc/apache2/apache2.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/apache2.conf
curl -o /etc/apache2/sites-available/wsgi-keystone.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/wsgi-keystone.conf
...
export OS_URL=http://apicontroller:35357/v3
export OS_IDENTITY_API_VERSION=3
openstack service create --name keystone --description "OpenStack Identity" identity
openstack endpoint create --region RegionOne identity public http://apicontroller:5000/v2.0
openstack endpoint create --region RegionOne identity internal http://apicontroller:5000/v2.0
openstack endpoint create --region RegionOne identity admin http://apicontroller:35357/v2.0
        ;;
    *)
        echo "Moving next step..."
        ;;
...
openstack --os-auth-url http://apicontroller:35357/v3 --os-project-domain-id default --os-user-domain-id default --os-project-name admin --os-username admin --os-password $ADMIN_PASS token issue
openstack --os-auth-url http://apicontroller:5000/v3 --os-project-domain-id default --os-user-domain-id default --os-project-name demo --os-username demo --os-password $DEMO_PASS token issue
        ;;
    *)
        echo "Moving next step..."
        ;;
...
case $response in
    [yY][eE][sS]|[yY]) 
        echo "Starting..."
curl -o /root/admin-openrc.sh https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/admin-openrc.sh
curl -o /root/demo-openrc.sh https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/demo-openrc.sh
...
openstack endpoint create --region RegionOne image public http://apicontroller:9292
openstack endpoint create --region RegionOne image internal http://apicontroller:9292
openstack endpoint create --region RegionOne image admin http://apicontroller:9292
apt-get -y install glance python-glanceclient
curl -o /etc/glance/glance-api.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/glance-api.conf
curl -o /etc/glance/glance-registry.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/glance-registry.conf
...
openstack endpoint create --region RegionOne compute public http://apicontroller:8774/v2/%\(tenant_id\)s
openstack endpoint create --region RegionOne compute internal http://apicontroller:8774/v2/%\(tenant_id\)s
openstack endpoint create --region RegionOne compute admin http://apicontroller:8774/v2/%\(tenant_id\)s
apt-get -y install nova-api nova-cert nova-conductor nova-consoleauth nova-novncproxy nova-scheduler python-novaclient
curl -o /etc/nova/nova.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/nova.conf
...
curl -o /etc/openstack-dashboard/local_settings.py https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/local_settings.py
...
openstack endpoint create --region RegionOne volume public http://apicontroller:8776/v1/%\(tenant_id\)s
openstack endpoint create --region RegionOne volume internal http://apicontroller:8776/v1/%\(tenant_id\)s
openstack endpoint create --region RegionOne volume admin http://apicontroller:8776/v1/%\(tenant_id\)s
openstack endpoint create --region RegionOne volumev2 public http://apicontroller:8776/v2/%\(tenant_id\)s
openstack endpoint create --region RegionOne volumev2 internal http://apicontroller:8776/v2/%\(tenant_id\)s
openstack endpoint create --region RegionOne volumev2 admin http://apicontroller:8776/v2/%\(tenant_id\)s
apt-get -y install cinder-api cinder-scheduler python-cinderclient
curl -o /etc/cinder/cinder.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/cinder.conf
...
openstack endpoint create --region RegionOne object-store public http://apicontroller:8080/v1/AUTH_%\(tenant_id\)s
openstack endpoint create --region RegionOne object-store internal http://apicontroller:8080/v1/AUTH_%\(tenant_id\)s
openstack endpoint create --region RegionOne object-store admin http://apicontroller:8080/v1
apt-get -y install swift swift-proxy python-swiftclient python-keystoneclient python-keystonemiddleware memcached
mkdir /etc/swift
curl -o /etc/swift/proxy-server.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/proxy-server.conf
...
curl -o /etc/swift/swift.conf https://raw.githubusercontent.com/mustafatoraman/openstack/beta/master/openstack/swift.conf
...
openstack endpoint create --region RegionOne orchestration public http://apicontroller:8004/v1/%\(tenant_id\)s
openstack endpoint create --region RegionOne orchestration internal http://apicontroller:8004/v1/%\(tenant_id\)s
openstack endpoint create --region RegionOne orchestration admin http://apicontroller:8004/v1/%\(tenant_id\)s
openstack endpoint create --region RegionOne cloudformation public http://apicontroller:8000/v1
openstack endpoint create --region RegionOne cloudformation internal http://apicontroller:8000/v1
openstack endpoint create --region RegionOne cloudformation admin http://apicontroller:8000/v1
